                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Formulario Estudiante</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted font-14">
                                        Ingrese a continuacion los datos del <code>estudiante</code> que se quiere
                                        <code>registrar </code>
                                    </p>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="simpleinput"
                                                                        class="form-control" value="Estudiante"readonly>
                                                                </div>
