                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Formulario Admin</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Formulario Admin</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted font-14">
                                        Ingrese a continuacion los datos del <code>administrador</code> que se quiere
                                        <code>registrar </code>
                                    </p>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label for="example-number"
                                                                        class="form-label">Codigo o Cedula</label>
