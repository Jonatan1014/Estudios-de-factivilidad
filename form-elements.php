                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Formulario Libros</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Formulario Libros</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted font-14">
                                        Ingrese a continuacion los datos del <code>libro</code> que se quiere
                                        <code>registrar </code>
                                    </p>
