...
<!-- Mirrored from coderthemes.com/hyper_2/saas/form-fileuploads.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 16:33:45 GMT -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Subir archivos de Estudio de Factibilidad</h4>
                                    <p class="text-muted font-14">
                                        Se permite cargar archivos mediante arrastrar y soltar con vistas previas de
                                        imágenes.
                                    </p>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="file-upload-preview">
                                            <form action="action/upload-archivo.php" method="post" class="dropzone"
                                                ...
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <span class="text-muted font-13">Por favor verificar los archivos
                                                        <strong>antes</strong> de subirlos.</span>
                                                </div>

                                                <!-- Botón para enviar los archivos -->
                                                <button type="submit" class="btn btn-soft-primary mt-3">Subir
                                                    Archivos</button>
