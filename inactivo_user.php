                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="mt-4">Usuario inhabilitado</h3>
                            <p class="text-muted">Sucuenta ha sido suspenida, no tendra acceso a la biblioteca
                                de la
                                UDI.</p>
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-4">
                                    <div class="text-center mt-3 ps-1 pe-1">
                                        ...
                                        <h5 class="text-uppercase">¿Necesitas soporte?</h5>
                                        <p class="text-muted">Si necesitas ayuda, tienes dudas o crees que no deberias ser Usuario Inhabilitado, puedes comunicarte aqui <a href="mailto:#"
                                                class="text-muted fw-bold">sistem.udi.barranca@udi.edu.co</a></p>
                                    </div>
                                </div> <!-- end col-->
