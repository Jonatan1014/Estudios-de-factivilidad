...
require('includes/Class-Proveedores.php'); // Asegúrate de incluir la clase correcta

$listProveedores = new Proveedores();
$listProveedores = $listProveedores->listarProveedores();
?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Lista Proveedores</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <div class="tab-pane show active" id="scroll-vertical-preview">
                                            ...
                                            <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
        foreach ($listProveedores as $user) { ?>
                                                    <tr>
                                                        <td><?= htmlspecialchars($user["proveedor"]) ?></td>
                                                        <td><?= htmlspecialchars($user["contacto"]) ?></td>
                                                        <td><?= htmlspecialchars($user["telefono"]) ?></td>
                                                        <td><?= htmlspecialchars($user["tema_asociado"]) ?></td>
                                                        <td><?= htmlspecialchars($user["ciudad"]) ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="form-register-user.php" method="POST"
