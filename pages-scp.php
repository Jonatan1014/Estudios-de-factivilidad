<?php
    ...
    require 'includes/Class-scp.php'; // Asegúrate de incluir la clase correcta

    $listMaterialesSCP = new SCP();
    $listMaterialesSCP = $listMaterialesSCP->listar_SCP_2();
?>
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Lista Materiales SCP</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Lista Materiales SCP</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <div class="tab-pane show active" id="scroll-vertical-preview">
                                            ...
                                            <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    foreach ($listMaterialesSCP as $user) {?>
                                                    <tr>
                                                        <td><?php echo htmlspecialchars($user["producto_descripcion"])?></td>
                                                        <td><?php echo htmlspecialchars($user["cantidad"])?></td>
                                                        <td style="text-align: right; font-family: monospace;">
                                                            <?php echo "$" . number_format($user["valorunitario"], 2)?>
                                                        </td>
                                                        <!-- <td><?//= htmlspecialchars($user["unidad"]) ?></td> -->
                                                        <td><?php echo htmlspecialchars($user["fecha_compra"])?></td>
                                                        <!-- <td><?//= htmlspecialchars($user["proveedor_nit"]) ?></td> -->
                                                        <td><?php echo htmlspecialchars($user["proveedor_nombre"])?></td>
                                                        <td><?php echo htmlspecialchars($user["datosproveedor"])?></td>
